...
Evaluating Quantitative Measures for Assessing Functional Similarity in Engineering Design (Nandy et al., Journal of Mechanical Design)  
Do human and computational evaluations of similarity align? An empirical study of product function (Nandy and Goucher-Lambert, Journal of Mechanical Design)  
Semantic properties of word prompts shape design outcomes: understanding the influence of semantic richness and similarity (Nandy et al., Design Computing and Cognition)  
