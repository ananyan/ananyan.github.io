...
See the following publications for more details about the project mentioned here:
GeneratiVR: Spatial Interactions in Virtual Reality to Explore Generative Design Spaces (Jennings, Nandy et al., CHI Extended Abstracts 2022)    
VR or Not? Investigating Interface Type and User Strategies for Interactive Design Space Exploration (Nandy et al., International Conference on Engineering Design 2023)   
